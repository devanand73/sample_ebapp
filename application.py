...
<head>
  ...
  <title>Welcome to elastic bean stalk deployment</title>
  <style>
  body {
    color: #ffffff;
...
<body id="sample">
  ...
  <div class="linksColumn"> 
    <h2>What's Next?</h2>
    <ul>
    <li><a href="http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/">AWS Elastic Beanstalk is working</a></li>
